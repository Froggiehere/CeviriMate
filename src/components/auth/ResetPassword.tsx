...
export const ResetPassword: React.FC = () => {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let message = 'Parola sıfırlama işlemi başarısız oldu.';
    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-primary/10 dark:border-accent/20">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-primary dark:text-accent">Parola Sıfırlama</h1>
          ...
          <div className="space-y-6">
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-md">
              <p className="text-sm text-green-800 dark:text-green-200">
                E-posta adresinize gönderilen bağlantıya tıklayarak parolanızı sıfırlayabilirsiniz.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              <button
                ...
                className="px-4 py-2 text-primary dark:text-accent border border-primary/30 dark:border-accent/30 
                           hover:bg-primary/10 dark:hover:bg-accent/10 rounded-md transition duration-200"
              >
